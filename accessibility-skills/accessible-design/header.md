---
id: accessibility-skills-design-header
...
## How to test a header  design

A header landmark must meet WCAG principles:
...
A header landmark must work for people with disabilities:

---
id: accessibility-skills-design-checkbox
title: "Checkbox"
platform: design
skill_type: component-assessment
version: 1.0.0
generated: "2026-09-13"
source: https://www.atomica11y.com/accessible-design/checkbox/
---

[Source material](https://www.atomica11y.com/accessible-design/checkbox/)

# Design Checkbox skills



## How to test a checkbox design

A checkbox must meet WCAG principles:
...
- Checkbox is in visual proximity to label - 3.3.2 A

### 4. Robust

- Name, role, state, description is documented  4.1.2 A
- Meets criteria across platforms, devices and viewports 4.0.0 AA

A checkbox must work for people with disabilities:

### Low vision

- Text has a 4.5:1 minimum contrast ratio - 1.4.3 AA
- Text can resize up to 200% with no loss of information - 1.4.4 AA
- Checkbox indicator is in visual proximity to label - 3.3.2 A
- The checkbox indicator has a 3:1 minimum contrast ratio across states and against adjacent elements - 1.4.11 A

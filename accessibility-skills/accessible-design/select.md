---
id: accessibility-skills-design-select
title: "Select dropdown"
platform: design
skill_type: component-assessment
version: 1.0.0
generated: "2026-09-15"
source: https://www.atomica11y.com/accessible-design/select/
---

[Source material](https://www.atomica11y.com/accessible-design/select/)

# Design Select dropdown skills



## How to test a select dropdown design

A select dropdown must meet WCAG principles:

### 1. Perceivable

- Color is not used as the only means of conveying state (valid/invalid) - 1.4.1 A
- The text has a 4.5:1 minimum contrast ratio - 1.4.3 AA
- Text can resize up to 200% with no loss of information - 1.4.4 AA
- Description, autofill is documented - 1.3.5 AA
...
A select dropdown must work for people with disabilities:
...
- Color is not used as the only means of conveying state (selected/not selected) - 1.4.1 A

### Cognitive

- Description, autofill documented - 1.3.5 AA

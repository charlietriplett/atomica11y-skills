---
id: accessibility-skills-design-toggle-switch
title: "Toggle switch"
platform: design
...
[Source material](https://www.atomica11y.com/accessible-design/toggle-switch/)

# Design Toggle switch skills



## How to test a toggle switch design

A toggle switch must meet WCAG principles:

### 1. Perceivable

- Color is not used as the only means of conveying meaning (on/off) - 1.4.1 A
...
- The switch indicator has a 3:1 minimum contrast ratio across states and against adjacent elements - 1.4.11 A

### 2. Operable

- Is keyboard operable - 2.1.1
...
- Toggle handle is in visual proximity to label - 3.3.2 A
...
A toggle switch must work for people with disabilities:
...
- Is used as on/off switch for immediate application settings - 4.1.2 A
- State is not included in the label - 4.1.2 A
- Name, role, state is documented - 4.1.2 A
- Meets criteria across platforms, devices and viewports 4.0.0 AA

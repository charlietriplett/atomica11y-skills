---
id: accessibility-skills-android-tabs
title: "Tabs"
platform: android
skill_type: component-assessment
version: 1.0.0
generated: "2026-09-15"
source: https://www.atomica11y.com/accessible-android/tabs/
---

[Source material](https://www.atomica11y.com/accessible-android/tabs/)
...
Given that I am on a screen with a tabs

### 1. Keyboard only

- WHEN I use the tab key or arrow key to move focus to a tab

  - I SEE focus is visually indicated

- THEN when I use spacebar or enter to activate the tab
...
- WHEN I use a screenreader AND I swipe to focus on a tab
  ...
  - I HEAR it expresses its state (disabled, selected)

---
id: atomica11y-skills-design-button
title: "Button"
description: Design accessible Button. Use when a control performs an action, submits a form, or changes content on the current screen.
platform: design
skill_type: component-assessment
version: 1.0.0
generated: "2026-09-17"
source: https://www.atomica11y.com/accessible-design/button/
---

[Source material](https://www.atomica11y.com/accessible-design/button/)

# Design Button skills



## How to test a button design

A button must meet WCAG principles:
...
- Text name has a 4.5:1 minimum contrast ratio 1.4.3 AA
- Icon used as button name has a 3:1 minimum contrast ratio 1.4.11  AA
...
A button must work for people with disabilities:

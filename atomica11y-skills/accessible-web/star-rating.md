---
id: atomica11y-skills-web-star-rating
title: "Star rating input"
description: Code and test accessible Web Star rating input. Use when people select a Web rating using a star-based control.
platform: web

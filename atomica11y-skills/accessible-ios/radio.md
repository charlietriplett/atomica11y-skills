---
id: atomica11y-skills-ios-radio
title: "Radio button"
description: Test accessible iOS Radio button\". Use when people select exactly one option from a related group.
platform: ios
...
[Source material](https://www.atomica11y.com/accessible-ios/radio/)

# iOS Radio button skills
...
- WHEN I use a screenreader AND I swipe to focus on a button
  ...
  - I HEAR it expresses its state (selected, dimmed)
